package com.pararam2006.recipesapi.presentation.details
...
import com.pararam2006.recipesapi.presentation.details.widget.ExtendedIngredientItem
import com.pararam2006.recipesapi.presentation.details.widget.StepItem
import com.pararam2006.recipesapi.presentation.main.widget.RecipeCard
...
fun DetailsScreen(
    ...
    val allSteps = recipe.analyzedInstructions.flatMap { instruction -> instruction.steps }
    LazyColumn(
...
//            key = { ingredient -> ingredient.id }
        ...
        item {
            Text(
                text = stringResource(R.string.cooking_steps_tab_title),
                style = MaterialTheme.typography.titleLarge
            )
        }
